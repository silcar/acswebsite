...
/* this line customized for Fearless theme */ parent::__construct( 'quick-flickr-widget', 'Fearless Flickr Widget', array(
			'description' => 'Display up to 20 of your latest Flickr submissions in your sidebar.',
		) );
	}
...
/* this line customized for Fearless theme */ $src = str_replace( '_m.jpg', '_q.jpg', $src );
	...
	public function form( $instance ) {
		...
		<p>
			<label for="<?php echo $this->get_field_id( 'username' ); ?>"><?php /* this line customized for Fearless theme */ _e( 'RSS URL:' ); ?></label> 
